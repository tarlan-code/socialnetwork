    ...
    public partial class CreateEventTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventAttends", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventAttends_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventAttends_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventAttends_AppUserId",
                table: "EventAttends",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_EventAttends_EventId",
                table: "EventAttends",
                column: "EventId");
