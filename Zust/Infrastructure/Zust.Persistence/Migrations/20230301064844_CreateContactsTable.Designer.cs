...
namespace Zust.Persistence.Migrations
{
    ...
    [Migration("20230301064844_CreateContactsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zust.Domain.Entities.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Zust.Domain.Entities.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Zust.Domain.Entities.EventAttend", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Zust.Domain.Entities.EventCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Zust.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Zust.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasOne("Zust.Domain.Entities.EventCategory", "EventCategory")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Zust.Domain.Entities.EventAttend", b =>
                {
                    b.HasOne("Zust.Domain.Entities.AppUser", "AppUser")
                        .WithMany("EventAttends")
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Zust.Domain.Entities.Event", "Event")
                        .WithMany("EventAttends")
