        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EducationOrWorks = table.Column<string>(type: "nvarchar(max)", maxLength: 10000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Relations_RelationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friends_AspNetUsers_ReceiveId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WhoCanSeeYourProfile = table.Column<bool>(type: "bit", nullable: true),
                    WhoCanSendFollow = table.Column<bool>(type: "bit", nullable: true),
                    WhoCanSeeYourPhone = table.Column<bool>(type: "bit", nullable: true),
                    WhoCanSeeMyBirthday = table.Column<bool>(type: "bit", nullable: true),
                    AppUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PrivacySettings_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_RelationId",
                table: "AspNetUsers",
                column: "RelationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friends_ReceiveId_SenderId",
                table: "Friends",
                columns: new[] { "ReceiveId", "SenderId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Friends_SenderId_ReceiveId",
                table: "Friends",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrivacySettings_AppUserId",
